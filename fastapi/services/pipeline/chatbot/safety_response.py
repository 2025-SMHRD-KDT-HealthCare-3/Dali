...
_RESPONSES: dict[str, str] = {
    ...
    # 타인 가해 의도(violence) 감지 시 전용 응답
    "violence_urgent_safety_mode": (
        "지금 화가 매우 크게 올라온 상태처럼 보여요.\n"
        "하지만 누군가를 해치는 행동으로 이어지지 않도록, 지금은 안전을 먼저 확인하는 것이 중요해요.\n\n"
        "가능하다면 그 사람과 물리적으로 거리를 두고, "
        "가까운 사람이나 도움을 받을 수 있는 곳에 바로 연락해 주세요.\n"
        "긴급한 상황이라면 📞 112에 연락해 주세요.\n"
        "📞 정신건강위기상담전화 1577-0199에서도 도움을 받을 수 있어요."
    ),
}
